...
/** Building Session #3 — 1h 45m on the local countdown. */
const ARENA3_BASE_DURATION_SEC = 60 * 60 + 45 * 60;
...
export default function Arena3Page() {
  ...
  const [sessionSeconds, setSessionSeconds] = useState(ARENA3_BASE_DURATION_SEC);
  const [remainingSec, setRemainingSec] = useState(ARENA3_BASE_DURATION_SEC);
  ...
  function resetLocalSession() {
    setPhase("ceremony");
    setSessionSeconds(ARENA3_BASE_DURATION_SEC);
    setRemainingSec(ARENA3_BASE_DURATION_SEC);
                ...
                {showEnded ? (
                  <div className="arena-end-band" role="status" aria-live="polite">
                    ...
                    <div className="arena-end-band__body">
                      ...
                      <Link className="btn-primary arena-end-band__next" href="/showdown">
                        Next
                      </Link>
                    </div>
