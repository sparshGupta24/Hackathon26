...
const ARENA1_BASE_DURATION_SEC = 60 * 60;
...
export default function Arena1Page() {
  ...
  const [sessionSeconds, setSessionSeconds] = useState(ARENA1_BASE_DURATION_SEC);
  const [remainingSec, setRemainingSec] = useState(ARENA1_BASE_DURATION_SEC);
  ...
  function resetLocalSession() {
    setPhase("ceremony");
    setSessionSeconds(ARENA1_BASE_DURATION_SEC);
    setRemainingSec(ARENA1_BASE_DURATION_SEC);
                ...
                {showEnded ? (
                  <div className="arena-end-band" role="status" aria-live="polite">
                    ...
                    <div className="arena-end-band__body">
                      ...
                      <Link className="btn-primary arena-end-band__next" href="/tea">
                        Next
                      </Link>
                    </div>
